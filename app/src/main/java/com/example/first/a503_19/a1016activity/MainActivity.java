...
public class MainActivity extends AppCompatActivity {
    ...
    //여기에 변수를 선언하면 클래스 내의 모든 곳에서 변수를 사용할 수 있습니다.
    Button contact;
    Button camera;
    Button voice;
    Button map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reqWidth = getResources()
                .getDimensionPixelOffset(
                        R.dimen.request_image_width);
        reqHeight = getResources()
                .getDimensionPixelOffset(
                        R.dimen.request_image_height);
